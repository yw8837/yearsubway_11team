...
> 작성일 2026-06-26<br>
> 
> **서울 지하철 혼잡 데이터 분석 — 역×시간 자원 배치 우선순위**<br>
...
report/        제출 보고서(PDF) · 슬라이드형 보고서(PPTX/PDF) + 소스
...
- 보고서 — `report/[T-XI]한정된 운영 자원, 어디에 먼저 투입할 것인가(보고서).pdf`
- 슬라이드형 보고서 — `report/[T-XI]한정된 운영 자원, 어디에 먼저 투입할 것인가(슬라이드).pptx` (21장 · 가로형 장표 · 제출 메인)
- 분석 노트북 — `[T-XI] 서울지하철_혼잡도분석 (노트).ipynb` (보고서 흐름 통합 · 외부 Join 검증 · 차트 포함)
  - 단계별: `notebooks/` ②로드 ③EDA ④심화 ⑤솔루션 (①기획은 기획서, ⑥은 위 보고서)
